...
public class VrActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
  ...
  public void onCreate(Bundle savedInstance) {
    ...
    nativeApp = nativeOnCreate(getAssets(), appid);
  ...
  private native long nativeOnCreate(AssetManager assetManager, String appid);
